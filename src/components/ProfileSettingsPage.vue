<template>
            ...
            <div :class="['dropdown-menu', { show: isProfileDropdownOpen }]">
              <div class="dropdown-content">
                <div class="profile-card">
                  ...
                  <a href="/profile/:username" class="dropdown-item">Profile Page</a>
                  <div class="dropdown-divider"></div>
    ...
    <div class="profile-header">
      <div class="profile-image">
        <img :src="profileImage" alt="Profile Picture" id="profile-preview" />
      ...
      <button @click="openModal" class="chg-btn">Change Photo</button>
    </div>
    ...
    <button class="btn-apply" @click="applyChanges">Apply</button>
    ...
    <div id="photoModal" v-if="isModalOpen" class="modal" @click.self="closeModal">
      <div class="modal-content">
        ...
        <button @click="removePhoto" class="red">Remove Current Photo</button>
